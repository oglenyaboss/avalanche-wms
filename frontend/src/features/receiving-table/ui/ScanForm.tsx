...
// A single scanned-code input shared by every desk-receiving step. The scanner
// is a keyboard wedge: it types the code and presses Enter, so the input must
// stay focused and clear itself after each scan.
